  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        {/* Right Column: Dynamic workspace content (8 columns) */}
        <div className="lg:col-span-8 flex flex-col h-full">
          ...
          {activeTab === 'docs' ? (
            ...
            <div className="flex-1 bg-white rounded-2xl border border-slate-200/80 shadow-md p-6 flex flex-col h-full min-h-[500px]">
