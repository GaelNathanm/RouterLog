...
import { CheckCircle, X, Camera, Trash2, Image } from 'lucide-react';
              ...
              {confirmPhotos.length < 5 ? (
                !showPhotoSourceOptions ? (
                  <button
                    ...
                    className="flex items-center gap-1 bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold text-[10px] uppercase tracking-wide px-3.5 py-2.5 rounded-xl border border-indigo-700 shadow-sm transition-all cursor-pointer hover:scale-[1.02] active:scale-95 select-none animate-pulse"
                  >
                  ...
                  <div className="flex items-center gap-1.5 animate-scale-up">
                    <label className="relative flex items-center gap-1 bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-[9px] uppercase tracking-wide px-2.5 py-2 rounded-xl border border-emerald-750 shadow-sm transition-all cursor-pointer hover:scale-[1.02] active:scale-95 select-none">
                    ...
                    <label className="relative flex items-center gap-1 bg-sky-500 hover:bg-sky-600 text-white font-extrabold text-[9px] uppercase tracking-wide px-2.5 py-2 rounded-xl border border-sky-650 shadow-sm transition-all cursor-pointer hover:scale-[1.02] active:scale-95 select-none">
                      <Image className="w-3 h-3 text-sky-100" />
                      Galeria
                      <input 
                        type="file" 
                        accept="image/*" 
                    ...
                    <button
                      ...
                      className="p-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded-xl text-slate-500 hover:text-slate-850 transition-colors cursor-pointer active:scale-95"
                      title="Cancelar"
                    >
                      <X className="w-3 h-3" />
                    </button>
